...
* **Bash**
	...
	* [anirudhb/purer](https://github.com/anirudhb/purer): Synchronous Git, npm, and SSH check, shows outdated dependencies, able to resolve to relative path, and username is always shown. Uses chalk for color
* **Fish**
