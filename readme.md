...
* **Bash**
	...
	* [anirudhb/purer](https://github.com/anirudhb/purer): Synchronous Git, NPM, and SSH check, shows outdated dependencies, able to resolve to relative path, and username is always shown. With color!
* **Fish**
